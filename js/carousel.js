define(["jquery"], function($) {
  ...
  var html = `    <ul class="carousel-content clearfix">
          <li><a href="#"><img src="./sources/carousel/1.jpg" alt=""></a></li>
          <li><a href="#"><img src="./sources/carousel/2.jpg" alt=""></a></li>
          <li><a href="#"><img src="./sources/carousel/3.jpg" alt=""></a></li>
          <li><a href="#"><img src="./sources/carousel/4.jpg" alt=""></a></li>
        </ul>
        <span class="carousel-arrow pre">&lt;</span>
